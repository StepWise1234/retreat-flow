...
function CheckboxGroup({ items, selected, onChange, otherValue, onOtherChange }: {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
      {items.map((item) => (
        <label key={item} className="flex items-center gap-2 rounded-lg border border-black/10 bg-white/50 px-3 py-2 text-sm cursor-pointer hover:bg-white/70 transition-colors">
      ...
      {onOtherChange !== undefined && (
        <div className="sm:col-span-2">
          <label className="flex items-start gap-2 rounded-lg border border-black/10 bg-white/50 px-3 py-2 text-sm cursor-pointer hover:bg-white/70 transition-colors">
            <Checkbox
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <main className="form-dark mx-auto max-w-3xl px-4 py-8 sm:px-6">
        ...
        {/* Form card — frosted glass with readable dark text */}
        <div className="rounded-2xl border border-white/20 bg-white/70 backdrop-blur-2xl p-6 sm:p-8 shadow-[0_8px_32px_hsl(0_0%_0%/0.25)] animate-fade-in">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {TRAINING_DATES.map((date) => (
                  <label key={date} className="flex items-center gap-2 rounded-lg border border-black/10 bg-white/50 px-3 py-2.5 text-sm cursor-pointer hover:bg-white/70 transition-colors">
                    <Checkbox
          ...
          {step === 6 && (
            <div className="space-y-6">
              ...
              <div className="rounded-lg border border-black/10 bg-white/50 p-4 text-sm text-foreground space-y-2">
              ...
              <label className="flex items-start gap-3 rounded-lg border border-black/10 bg-white/50 px-4 py-3 cursor-pointer hover:bg-white/70 transition-colors">
                <Checkbox
...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <h3
      className="text-sm font-semibold text-foreground border-l-2 pl-3"
      style={{ borderColor: 'hsl(160 30% 72%)' }}
    >
      {children}
    </h3>
  );
