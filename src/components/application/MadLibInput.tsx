  ...
  return (
    <span className={cn('madlib-field group/ml inline-block relative', className)}>
      <input
        ...
        className="bg-transparent border-none outline-none font-bold text-foreground placeholder:text-muted-foreground/40 placeholder:font-normal w-full py-0.5 text-inherit"
      />
      {/* Rainbow underline */}
