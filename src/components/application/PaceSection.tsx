...
export default function PaceSection() {
  ...
  return (
    <section className="relative bg-background overflow-hidden">
      <div className="relative mx-auto flex max-w-6xl items-center justify-center px-6 pt-0 pb-24 min-h-[70vh] overflow-visible">
            ...
            i === activeIndex ? (
              ...
              >
                ...
                <div className="relative flex items-center justify-center overflow-visible">
                  ...
                  {/* Silhouette */}
                  <motion.div
                    className="relative z-10 h-[34rem] w-[23.2rem] sm:h-[39.6rem] sm:w-[28rem] md:h-[46.8rem] md:w-[33.6rem] overflow-visible"
