    ...
    <section className="relative overflow-hidden bg-background">
      <div className="relative mx-auto flex max-w-6xl items-center justify-center px-6 py-24 md:py-32 min-h-[70vh]">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <motion.div
            className="absolute h-64 w-64 rounded-full sm:h-72 sm:w-72 md:h-[22rem] md:w-[22rem] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
            style={{
        ...
        <motion.p
          className="hidden md:block absolute right-6 lg:right-12 top-1/2 -translate-y-1/3 text-6xl lg:text-7xl xl:text-8xl font-bold leading-[0.9] tracking-tight text-foreground z-10"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true, margin: '-80px' }}
          transition={{ duration: 0.8, delay: 1.2, ease: 'easeOut' }}
