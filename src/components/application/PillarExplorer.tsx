...
const pillars = [
  {
    ...
    description:
      'Imagine a space where your body sets the pace — not a clock, not a protocol, not someone else\'s idea of "ready." StepWise tracks the subtle language of your nervous system in real time, honoring each micro-signal of capacity. You never outrun your own ability to process. The result? A depth of safety that lets you open fully — because your body knows it\'s in control.',
    details: [
  ...
  return (
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="relative mx-auto max-w-3xl px-6 py-20 md:py-28">
        ...
        >
          Three principles that make the difference between insight and lasting change.
        </motion.p>
        ...
        <div className="min-h-[320px] sm:min-h-[300px]">
          <AnimatePresence mode="wait">
            {activePillar ? (
              ...
              >
                Tap a circle above to discover what makes StepWise unlike anything else.
              </motion.p>
            )}
          </AnimatePresence>
        </div>
