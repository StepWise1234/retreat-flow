...
const levels = [
  {
    ...
    title: 'Beginning',
    accentColor: '#FFA500',
    subtitle: 'The Complete StepWise Foundation',
    description:
      'Where every practitioner starts — and where the most important skills are forged. Beginning covers everything you need to serve StepWise clients, from sub-perceptual micro-doses all the way up to full-embrace sessions. You\'ll learn to read the nervous system in real time, recognize micro-signals of capacity, and guide clients through progressively deeper experiences with confidence. This single training equips you with the full clinical toolkit: titrated dosing, somatic tracking, emotional release navigation, multi-session arc design, and full-release facilitation.',
    details: [
      'Ultra-low dose protocols through full-embrace session facilitation',
  ...
  },
  {
    ...
    description:
      'Once you\'ve completed Beginning, deepen your expertise through focused weekend workshops. Each intensive is designed to sharpen a specific clinical edge — choose the specialty that matches your practice and your clients\' needs.',
    details: [
      'Workshop 1: Nervous System + PTSD — advanced protocols for trauma-informed facilitation and complex nervous system presentations',
      'Workshop 2: Touch + Wounded Inner Child — somatic touch techniques and inner-child integration for deeper emotional processing',
      'Workshop 3: Relational Intelligence — navigating relational dynamics, transference, and co-regulation in the therapeutic container',
    ],
  },
  {
    id: 'advanced',
