...
const levels = [
  {
    ...
    description:
      'Where every practitioner starts — and where the most important skills are forged. Beginning-level training grounds you in the science of titrated 5-MeO-DMT administration, from sub-perceptual micro-doses through moderate protocols and into full-release sessions. You\'ll learn to read the nervous system in real time, recognize micro-signals of capacity, and guide clients through progressively deeper experiences where safety, trust, and somatic coherence are maintained at every stage. This is the complete foundation — precision, expansion, and mastery in one integrated arc.',
    details: [
  ...
  },
  {
    ...
    description:
      'With a complete foundation in place, Intermediate training offers focused weekend workshops that deepen your skills in three critical clinical domains. Each workshop is a standalone intensive — choose one, two, or all three based on your practice needs and client population. These are where generalist facilitators become specialists.',
    details: [
      'Nervous System + PTSD — trauma-informed protocols for clients with complex PTSD, dissociative patterns & hypervigilance',
      'Touch + Parts-Work — somatic touch modalities integrated with internal family systems and wounded inner-child work',
      'Relational Intelligence — attachment wound repair, co-regulation dynamics & relational field facilitation',
    ],
  },
  {
    id: 'advanced',
